...
/**
 * Created by MOULIE415 on 27/11/2016.
 */
public class ControllerFX {


    private Match theModel;
    private ViewFX theView;
    private String player1;
    private String player2;

    public ControllerFX(Match theModel, ViewFX view, String p1, String p2) {
    ...
    public void buttonClicked(MouseEvent event) {
        if (event.getSource() == theView.getP1WinPoint()) {
            theModel.p1Score();
